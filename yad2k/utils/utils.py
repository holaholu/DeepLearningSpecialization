...
def draw_boxes(image, boxes, box_classes, class_names, scores=None):
    ...
    for i, c in list(enumerate(box_classes)):
        ...
        # Modern replacement for textsize (removed in Pillow 10+)
        # textbbox returns (left, top, right, bottom) relative to anchor point (0,0)
        bbox = draw.textbbox((0, 0), text=label, font=font)
        label_width = bbox[2] - bbox[0]   # right - left
        label_height = bbox[3] - bbox[1]  # bottom - top
